...
# This is copy from MongoDB driver for Python
# https://github.com/mongodb/mongo-python-driver/blob/master/bson/objectid.py
# Only simple use this code, so I don't want to need to install the driver
...
ZERO: datetime.timedelta = datetime.timedelta(0)
...
class FixedOffset(datetime.tzinfo):
    ...
    def __init__(self, offset: Union[float, datetime.timedelta], name: str) -> None:
    ...
    def __getinitargs__(self) -> tuple[datetime.timedelta, str]:
